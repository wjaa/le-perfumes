...
public class ClienteForm {
	...
	public static Collection<ClienteForm> toList(List<Cliente> all) {
		Collection<ClienteForm> clientes = new ArrayList<ClienteForm>();
		if (CollectionUtils.isNotEmpty(all)){
			for (Cliente c : all){
				clientes.add(new ClienteForm(c));
			}
		}
		return clientes;
	}
